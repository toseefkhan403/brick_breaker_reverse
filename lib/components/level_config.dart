...
final level1 = LevelConfig(moveSpeed: 300, intervalMilliseconds: 3200);
final level2 = LevelConfig(moveSpeed: 350, intervalMilliseconds: 2000);
final level3 = LevelConfig(moveSpeed: 400, intervalMilliseconds: 1500);
